...
// --------------------------------------------------------------
// biwi.region.RelationshipWindow
// --------------------------------------------------------------
kijs.createNamespace('biwi.region');

biwi.region.RelationshipWindow = class biwi_region_RelationshipWindow extends biwi.default.DefaultFormWindow {
    // --------------------------------------------------------------
    // CONSTRUCTOR
    // --------------------------------------------------------------
    constructor(config={}) {
        ...
        Object.assign(this._defaultConfig, {
            ...
            assignTable: 'regionRelationship',
            primaryKey: 'regionRelationshipId'
        });
        ...
        this.form.facadeFnSave = 'region.saveRelationship';
